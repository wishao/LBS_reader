 ...
 * @author johnny0086
 */
Ext.namespace('IsmpHB', 'IsmpHB.orderworkflow');

IsmpHB.orderworkflow.WorkflowTree = Ext.extend(Ext.tree.TreePanel, {
	useArrows : true,
	autoScroll : true,
	animate : false,
	enableDD : true,
	...
	loader : new Ext.tree.TreeLoader({
		dataUrl : IsmpHB.req.WORKFLOW_QUERY,
	...
	constructor : function(config) {
		config = config || {};
		IsmpHB.orderworkflow.WorkflowTree.superclass.constructor.apply(this,
				arguments);
...
IsmpHB.orderworkflow.WorkflowTreeDlg = Ext.extend(Ext.Window, {
	title : '查看流程',
	layout : 'fit',
	modal : true,
	width : 425,
	...
	constructor : function(config) {
		...
		this.tree = new IsmpHB.orderworkflow.WorkflowTree({});
		config.items.push(this.tree);
		IsmpHB.orderworkflow.WorkflowTreeDlg.superclass.constructor.apply(this,
				arguments);
...
IsmpHB.orderworkflow.DataGrid = Ext
		.extend(
				Ext.grid.GridPanel,
				{
					title : '工单流程管理',
					...
					constructor : function(config) {
						this.dlg = new IsmpHB.orderworkflow.WorkflowTreeDlg({});
							...
							items : [
									{
										xtype : 'toolbar',
										border : false,
										items : [ '客户电话：', this.telField,
												'客户姓名：', this.nameField,
												'操作类型：', this.stypeCombo,
									...
									},
									{
										...
										items : [ '号百产品包', this.hbPkgField,
												'创建日期：', this.dbField, '更新日期：',
												this.ddField, '地市：',
												this.cityCombo, '数据源：',
												this.dataSrc ]
						...
						this.cm = new Ext.grid.ColumnModel(
								[
										...
										},
										{
											...
											menuDisabled : true,
											dataIndex : 'payType',
											renderer : IsmpHB.renderer.PAY_TYPE,
											width : 70
										},
										{
											header : '工单渠道',
										...
										// renderer :
										// IsmpHB.renderer.ORDER_BUSI_RESULT,
										// width : 100
										// },
										// {
										// header : '渠道产品包编码',
						...
						IsmpHB.orderworkflow.DataGrid.superclass.constructor
						...
						this.redoBtn.on('click', function() {
							...
							Ext.MessageBox.confirm("提示", "确认要重做所选工单吗？",
									function(id) {
										if (id == "yes") {
											this.redoItems();
										}
					...
					changeItemsStatus : function() {
						...
						var req = {
							url : IsmpHB.req.ORDER_CHANGESTATUS,
							params : {
								timestamp : new Date().valueOf(),
								data : Ext.encode(ps)
							},
