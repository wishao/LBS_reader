 ...
 * @author farago
 */
Ext.namespace('IsmpHB', 'IsmpHB.monitor_GD160');
IsmpHB.monitor_GD160.DataGrid = Ext.extend(Ext.grid.GridPanel,
		{
			title : '全省联网160',
			autoScroll : true,
			...
			constructor : function(config) {
				...
				IsmpHB.monitor_GD160.DataGrid.superclass.constructor.apply(
						this, arguments);
