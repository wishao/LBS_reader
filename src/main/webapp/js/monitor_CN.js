 ...
 * @author farago
 */
Ext.namespace('LBSReader', 'LBSReader.monitor_CN');
LBSReader.monitor_CN.DataGrid = Ext.extend(Ext.grid.GridPanel, {
	title : '全国联网',
	autoScroll : true,
	store : Ext.StoreMgr.get('monitor_cn'),
	cls : 'box-dataGrid',
	...
	constructor : function(config) {
		...
		LBSReader.monitor_CN.DataGrid.superclass.constructor.apply(this,
				arguments);
