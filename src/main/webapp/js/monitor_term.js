 ...
 * @author farago
 */
Ext.namespace('LBSReader', 'LBSReader.monitor_term');
LBSReader.monitor_term.DataGrid = Ext.extend(Ext.grid.GridPanel, {
	title : '周/月环比',
	autoScroll : true,
	...
	constructor : function(config) {
		...
		this.cm = new Ext.grid.ColumnModel([this.sm, {
					...
					dataIndex : 'pay_type',
					width : 80,
					renderer : LBSReader.renderer.MONITOR_PAY_TYPE
				}, {
					header : '产品或套餐代码',
					align : 'left',
					menuDisabled : true,
		...
		LBSReader.monitor_term.DataGrid.superclass.constructor.apply(this,
				arguments);
