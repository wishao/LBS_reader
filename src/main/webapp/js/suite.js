 ...
 * @author johnny0086
 */
Ext.namespace('IsmpHB', 'IsmpHB.suite');

IsmpHB.suite.ProductGrid = Ext.extend(Ext.grid.GridPanel,
		{
			autoScroll : true,
			height : 230,
			...
			constructor : function(config) {
				...
				IsmpHB.suite.ProductGrid.superclass.constructor.apply(this,
						arguments);
...
IsmpHB.suite.ItemForm = Ext.extend(Ext.form.FormPanel, {
	labelWidth : 70,
	labelAlign : 'right',
	border : false,
	...
	constructor : function(config) {
		this.isEDIT = false;
		this.grid = new IsmpHB.suite.ProductGrid({});
		config = config || {};
		...
		IsmpHB.suite.ItemForm.superclass.constructor.apply(this, arguments);

	}
});

IsmpHB.suite.ItemDlg = Ext.extend(Ext.Window, {
	title : '套餐配置',
	layout : 'fit',
	modal : true,
	width : 350,
	...
	constructor : function(config) {
		config = config || {};
		config.items = config.items || [];
		this.configForm = new IsmpHB.suite.ItemForm({});
		config.items.push(this.configForm);
		IsmpHB.suite.ItemDlg.superclass.constructor.apply(this, arguments);
...
IsmpHB.suite.DataGrid = Ext.extend(Ext.grid.GridPanel, {
	title : '套餐配置',
	autoScroll : true,
	...
	constructor : function(config) {
		this.dlg = new IsmpHB.suite.ItemDlg({});
		config = config || {};
		...
		IsmpHB.suite.DataGrid.superclass.constructor.apply(this, arguments);
