 ...
 */
Ext.namespace('LBSReader', 'LBSReader.premiumMg');

LBSReader.premiumMg.DataGrid = Ext.extend(Ext.grid.GridPanel, {
	title : '客户优惠管理',
	autoScroll : true,
	...
	constructor : function(config) {
		...
		var a = LBSReader.common.getPermission('5-2');
		...
		LBSReader.premiumMg.DataGrid.superclass.constructor.apply(this,
				arguments);
