	...
	constructor : function(config) {
		...
		this.packageCombo.on('expand', function(combo) {
					combo.getStore().each(function(r) {
								if (r.data.chargingCycle == 3||r.data.chargingCycle == 4||r.data.chargingCycle == 5) {
...
IsmpHB.orderuser.showAddView = function(grid, rowIndex, colIndex) {
	...
	order_user_productAddForm.get('order_package_billFlag')
			.setValue(IsmpHB.renderer.CHARGINGMODE(r.data.billFlag));
	...
	order_user_productAddForm.get('order_package_chargingCycle')
			.setValue(IsmpHB.renderer.CHARGINGCYCLE(r.data.chargingCycle));
	order_user_productAddForm.get('order_package_effectMode')
			.setValue(IsmpHB.renderer.EFFECTMODE(r.data.effectMode));
	order_user_productAddForm.get('order_package_withDrawMode')
			.setValue(IsmpHB.renderer.EFFECTMODE(r.data.withDrawMode));
	order_user_productAddForm.get('order_package_trialType')
			.setValue(IsmpHB.renderer.TRIAL_TYPE(r.data.trialType));
	...
	order_user_productAddForm.get('order_package_useFlag')
			.setValue(IsmpHB.renderer.VIEW_STATUS_FLAG(r.data.useFlag));
	order_user_productAddForm.get('order_package_beginCharg')
			.setValue(IsmpHB.renderer.BEGIN_RULE(r.data.beginCharg));
	order_user_productAddForm.get('order_package_endPreCharg')
			.setValue(IsmpHB.renderer.END_PRE_CHARG(r.data.endPreCharg));
	order_user_productAddForm.get('order_package_endAfterCharg')
			.setValue(IsmpHB.renderer.END_AFTER_CHARG(r.data.endAfterCharg));
...
IsmpHB.orderuser.showProduct = function(grid, rowIndex, colIndex) {
	...
	if (r.data.useFlag == IsmpHB.data.STATUS_FLAG.EFFECT
			...
			&& r.data.chargingCycle != IsmpHB.data.CHARGING_CYCLE.MINUTE
			&& r.data.chargingCycle != IsmpHB.data.CHARGING_CYCLE.SECOND) {
