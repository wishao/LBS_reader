/**
 * @author ggf 2012.11.28
 */

Ext.namespace('LBSReader', 'LBSReader.billOffer');

LBSReader.billOffer.DataGrid = Ext.extend(Ext.grid.GridPanel, {
			title : '话单报盘查询',
			autoScroll : true,
			...
			constructor : function(config) {
				...
				this.cm = new Ext.grid.ColumnModel([{
							 ...
							 * ,{ header : '地区代码', align : 'left', menuDisabled :
							 * true, dataIndex : 'areaCode', width : 200 }
							 */, {
							header : '付费类型',
							align : 'left',
							menuDisabled : true,
				...
				LBSReader.billOffer.DataGrid.superclass.constructor.apply(this,
						arguments);
			...
			searchData : function() {
				if (!this.telText.validate()
						|| this.telText.getValue().trim() == '') {
