 ...
 * @author johnny0086
 */
Ext.namespace('IsmpHB', 'IsmpHB.ecrmProductAdd');IsmpHB.ecrmProductAdd.DataPanel = Ext.extend(Ext.Panel, {
	title : '挂机体验用户录入',
	autoScroll : true,
	border : false,
	layout : "column",
	...
	userType : new Ext.form.ComboBox( {
		...
		store : new Ext.data.ArrayStore( {
			fields : [ 'id', 'name' ],
			data : [ [ '', '所有' ], [ '100001', '住宅用户' ], [ '100002', '商业用户' ],
					[ '100003', '企业用户' ], [ '100004', '单位用户' ],
					[ '100005', '军政用户' ], [ '100006', '农村住宅' ],
					[ '100020', '免费用户' ], [ '700001', '商务领航用户' ],
					[ '800001', '号码百事通用户' ], [ '900001', '人工代办公话' ],
					[ '900002', 'IC卡电话用户' ], [ '900006', '200专用电话用户' ],
					[ '900007', '200IC卡电话用户' ], [ '900009', '联名卡专用电话用户' ],
					[ 'ADSD01', '住宅用户(ADSD)' ], [ 'ADSD02', '商业用户(ADSD)' ],
					[ 'B5', '传呼台' ], [ 'B6', '分期付款大户' ], [ 'B7', '生产经营性公用电话' ],
					[ 'HMBST', '号码百事通用户' ], [ 'J1', '企e通私人用户' ],
					[ 'Q0', '局办营业厅电话' ], [ 'Q5', '生产用电话' ],
					[ 'QB', '多功能信息公话' ], [ 'QC', '测试电话' ], [ 'QD', '公务纳费电话' ],
					[ 'QE', '实业纳费电话' ] ]
		})
	}),
	billingType : new Ext.form.ComboBox( {
		...
		store : new Ext.data.ArrayStore( {
			fields : [ 'id', 'name' ],
			data : [ [ '000000', '无需设定月租(或固定月租)' ], [ '1003', '安全快车道月租' ],
					[ '1004', '80元包月' ], [ '100749', '企业加盟50元/年' ],
					[ '100762', '企业加盟5元/月' ], [ '100763', '企业加盟30元/月' ],
					[ '110008', '125元/月(QYZJ)' ], [ '110009', '240元/月(QYZJ)' ],
					[ '110010', '660元/月(QYZJ)' ],
					[ '110011', '1000元/月(QYZJ)' ], [ '110013', '普通(QYZJ)' ],
					[ '110017', '普通(PPCX)' ], [ '110018', '普通(LSBH)' ],
					[ '110044', '普通(SMCX)' ], [ '110053', '普通(QYMP)' ],
					[ '110054', '普通(ZLFW)' ], [ '110064', '普通(QYGG)' ],
					[ '110086', '460元/月(QYZJ)' ], [ '110087', '820元/月(QYZJ)' ],
					[ '110430', '普通用户30元/月' ], [ '111113', '宽带从帐号免月租' ],
					[ '111233', '20元/月(CXZJ)' ], [ '114041', '360元/年·号' ],
					[ '114XX1', '普通(114)' ], [ '11763', '企业名片(60秒100元)' ],
					[ '11776', '企业总机(200元/月)' ], [ '11777', '企业总机(125元/月)' ],
					[ '11778', '企业总机(150元/月人工)' ], [ '11852', '1800元半年' ],
					[ '11853', '50元/季度(CXZJ)' ], [ '5235', '户外-楼宇媒体广告费' ],
					[ '800', 'ADSD个人200包月' ] ]
		})
	}),
	userChar : new Ext.form.ComboBox( {
		...
		store : new Ext.data.ArrayStore( {
			...
			data : [ [ '000002', 'APS按月计' ], [ '000065', '全交' ],
					...
					[ 'JFSX22', '公免限额（150元/月）' ], [ 'JFSX23', '公免限额（200元/月）' ],
					[ 'JFSX24', '公免限额（300元/月）' ], [ 'JFSX25', '公务纳费(国内)' ],
					[ 'JFSX26', '公务纳费(本地)' ], [ 'JFSX27', '公务纳费(国际)' ],
					[ 'JFSX28', '公纳限额（120元/月）' ], [ 'JFSX29', '公纳限额（150元/月）' ],
					[ 'JFSX30', '公纳限额（200元/月）' ], [ 'JFSX31', '一站式受理(本地免费)' ],
	...
	dedudType : new Ext.form.ComboBox( {
		...
		store : new Ext.data.ArrayStore( {
			fields : [ 'id', 'name' ],
			data : [ [ '0000', '不处理' ], [ '1001', '限额划扣(含社会信息台和代收费)' ],
					[ '1002', '限额划扣(不含社会台和代收费)' ],
					[ '1003', '限时扣费(每月06~10日)' ], [ '1011', '短信银行划扣充值' ],
					[ '1012', '自动银行划扣充值' ] ]
		})
	}),
	payClass : new Ext.form.ComboBox( {
		...
		store : new Ext.data.ArrayStore( {
			fields : [ 'id', 'name' ],
			data : [ [ '0', '账户缴纳方式' ], [ '1', '服务代缴费方式' ], [ '2', '对端代缴费' ],
					[ '3', '省公司代缴' ], [ '4', '集团公司代缴' ], [ '5', '转帐' ] ]
		})
	}),
	cjdxtclx : new Ext.form.ComboBox( {
		...
		store : new Ext.data.ArrayStore( {
			fields : [ 'id', 'name' ],
			data : [ [ '3', '3/300条短信/38元' ], [ '4', '4/600条短信/68元' ],
					[ '5', '5/800条短信/88元' ], [ '6', '6/1600条短信/168元' ],
					[ '7', '7/3600条短信/368元' ], [ '8', '8/6800条短信/668元' ],
					[ '9', '3元/月，短信0.15元/条' ] ]
		})
	}),
		...
		config.items.push( [
				{
					...
					items : [ this.cityField, this.userType, this.billingType,
							this.userChar, this.dls, this.paymentType,
							this.dedudType, this.payClass, this.cjdxtclx ]
				},
				{
					columnWidth : .5,
					layout : 'form',
					bodyStyle : 'background-color:#dfe8f6;',
					bodyBorder : false,
					items : [ this.cjdxdxlx, this.msdeptName, this.msPhone,
							this.msMan, this.gjdx, this.payPhone,
							this.beginField, this.endField ]
				} ]);
		config.bbar.push(this.addBtn);
		config.bbar.push(this.resetBtn);
		IsmpHB.ecrmProductAdd.DataPanel.superclass.constructor.apply(this,
				arguments);
