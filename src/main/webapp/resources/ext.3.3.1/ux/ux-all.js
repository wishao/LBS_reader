		...
		.extend(
				Ext.grid.GridView,
				{
					...
					initTemplates : function() {
						Ext.ux.grid.BufferView.superclass.initTemplates
								.call(this);
					...
					getVisibleRows : function() {
						var a = this.getVisibleRowCount(), b = this.scroller.dom.scrollTop, c = (b === 0 ? 0
								: Math.floor(b / this.getCalculatedRowHeight()) - 1);
						return {
							first : Math.max(c, 0),
					...
					doRender : function(g, k, u, a, s, A, l) {
						var b = this.templates, f = b.cell, h = b.row, x = b.rowBody, n = s - 1, t = this
								.getStyleRowHeight(), z = this.getVisibleRows(), d = "width:"
								+ this.getTotalWidth() + ";height:" + t + "px;", D = [], w, E, v = {}, m = {
							tstyle : d
						}, q;
						for ( var y = 0, C = k.length; y < C; y++) {
							...
							if (e) {
								for ( var B = 0; B < s; B++) {
									E = g[B];
									v.id = E.id;
									v.css = B === 0 ? "x-grid3-cell-first "
											: (B == n ? "x-grid3-cell-last "
													: "");
									v.attr = v.cellAttr = "";
									v.value = E.renderer(q.data[E.name], v, q,
											o, B, u);
									v.style = E.style;
									...
									if (q.dirty
											&& typeof q.modified[E.name] !== "undefined") {
							...
							m.alt = F.join(" ");
							m.cells = w.join("");
							D[D.length] = !e ? b.rowHolder.apply(m) : (l ? x
									.apply(m) : h.apply(m))
						}
						return D.join("")
					},
					...
					syncScroll : function() {
						Ext.ux.grid.BufferView.superclass.syncScroll.apply(
								this, arguments);
						this.update()
					},
					update : function() {
					...
					onRemove : function(d, a, b, c) {
						Ext.ux.grid.BufferView.superclass.onRemove.apply(this,
								arguments);
						if (c !== true) {
							this.update()
						}
					...
					doUpdate : function() {
						if (this.getVisibleRowCount() > 0) {
							var f = this.grid, b = f.colModel, h = f.store, e = this
									.getColumnData(), a = this.getVisibleRows(), j;
							for ( var d = a.first; d <= a.last; d++) {
								if (!this.isRowRendered(d)
										&& (j = this.getRow(d))) {
									var c = this.doRender(e, [ h.getAt(d) ], h,
											d, b.getColumnCount(),
											f.stripeRows, true);
									j.innerHTML = c
								}
...
Ext.ns("Ext.ux.grid");
Ext.ux.grid.ColumnHeaderGroup = Ext
		.extend(
				Ext.util.Observable,
				{
					...
					viewConfig : {
						initTemplates : function() {
							this.constructor.prototype.initTemplates.apply(
									this, arguments);
							var a = this.templates || {};
							if (!a.gcell) {
							...
							this.templates = a;
							this.hrowRe = new RegExp(
									"ux-grid-hd-group-row-(\\d+)", "")
						},
						renderHeaders : function() {
							var h = this.templates, d = [], l = this.cm, p = l.rows, j = "width:"
									+ this.getTotalWidth() + ";";
							for ( var o = 0, k = p.length; o < k; o++) {
								...
								for ( var f = 0, e = 0, g = a.length; f < g; f++) {
									...
									var b = this.getColumnId(m.dataIndex ? l
											.findColumnIndex(m.dataIndex) : e), c = Ext.ux.grid.ColumnHeaderGroup.prototype.getGroupStyle
											.call(this, m, e);
									n[f] = h.gcell
											.apply( {
												...
												style : "width:"
														...
														+ (m.align ? "text-align:"
																+ m.align + ";"
																: ""),
												tooltip : m.tooltip ? (Ext.QuickTips
														.isEnabled() ? "ext:qtip"
														: "title")
														+ '="'
														+ m.tooltip
							...
							d.push(this.constructor.prototype.renderHeaders
									.apply(this, arguments));
							return d.join("")
						},
						onColumnWidthUpdated : function() {
							this.constructor.prototype.onColumnWidthUpdated
									.apply(this, arguments);
							Ext.ux.grid.ColumnHeaderGroup.prototype.updateGroupStyles
									.call(this)
						},
						onAllColumnWidthsUpdated : function() {
							this.constructor.prototype.onAllColumnWidthsUpdated
									.apply(this, arguments);
							Ext.ux.grid.ColumnHeaderGroup.prototype.updateGroupStyles
									.call(this)
						},
						onColumnHiddenUpdated : function() {
							this.constructor.prototype.onColumnHiddenUpdated
									.apply(this, arguments);
							Ext.ux.grid.ColumnHeaderGroup.prototype.updateGroupStyles
									.call(this)
						},
						...
						findHeaderCell : function(a) {
							return a ? this.fly(a).findParent("td.x-grid3-hd",
						...
						updateSortIcon : function(b, a) {
							var d = this.sortClasses, c = this.mainHd.select(
									this.cellSelector).removeClass(d);
						...
						handleHdDown : function(h, d) {
							...
							if (f.hasClass("x-grid3-hd-btn")) {
								...
								if (f.hasClass("ux-grid-hd-group-cell")
										|| Ext.fly(d).up(
							...
							if (g
								...
								if (this.grid.enableColumnResize !== false) {
									if (a - f.left <= b
										...
										if (f.right - a <= (!this.activeHdBtn ? b
												: 2)
												&& this.cm
						...
						handleHdOver : function(d, a) {
							...
							if (c && !this.headersDisabled) {
								...
								if (!(this.cm
										.isMenuDisabled(this.activeHdIndex) || b
						...
						handleHdMenuClick : function(q) {
							var l = this.hdCtxIndex, o = this.cm, d = this.ds, b = q
									.getItemId();
							switch (b) {
							case "asc":
							...
							default:
								if (b.substr(0, 6) == "group-") {
									var h = b.split("-"), s = parseInt(h[1], 10), e = parseInt(
											h[2], 10), a = this.cm.rows[s], p, f = 0;
									...
									if (q.checked) {
										var m = o.getColumnsBy(
												this.isHideableColumn, this).length;
								...
								if (b.substr(0, 6) == "group-"
									...
									while (g = g.parentMenu) {
										if (!g.parentMenu
												|| !(c = g.parentMenu.items
														.get(g.getItemId()))
												|| !c.setChecked) {
											break
										}
										var n = g.items
												.findIndexBy(function(r) {
													return r.checked
												}) >= 0;
										c.setChecked(n, true)
									}
						...
						beforeColMenuShow : function() {
							...
							for ( var d = 0, m = h.getColumnCount(); d < m; d++) {
								...
								if (h.config[d].fixed !== true
										&& h.config[d].hideable !== false) {
						...
						afterRenderUI : function() {
							this.constructor.prototype.afterRenderUI.apply(
									this, arguments);
							Ext
									.apply(
											this.columnDrop,
					...
					splitZoneConfig : {
						allowHeaderDrag : function(a) {
							return !a.getTarget(null, null, true).hasClass(
									"ux-grid-hd-group-cell")
						}
					},
					columnDropConfig : {
						...
						positionIndicator : function(b, f, d) {
							var c = Ext.ux.grid.ColumnHeaderGroup.prototype.getDragDropData
									.call(this, b, f, d);
							if (c === false) {
								return false
							}
							var a = c.px + this.proxyOffsets[0];
							this.proxyTop.setLeftTop(a, c.r.top
									+ this.proxyOffsets[1]);
							this.proxyTop.show();
						...
						onNodeDrop : function(o, A, v, C) {
							var u = C.header;
							if (u != o) {
								var x = Ext.ux.grid.ColumnHeaderGroup.prototype.getDragDropData
										.call(this, u, o, v);
								if (x === false) {
									return false
								}
								...
								for ( var f = x.row, p = k.length; f < p; f++) {
									...
									for ( var s = 0, m = 0; s < t; s++) {
										var g = l[s];
										if (x.oldIndex >= m
												&& x.oldIndex < m + g.colspan) {
											B = s
										}
										if (x.oldIndex + x.colspan - 1 >= m
												&& x.oldIndex + x.colspan - 1 < m
														+ g.colspan) {
											q = s - B + 1
										}
										if (x.newIndex >= m
												&& x.newIndex < m + g.colspan) {
											D = s
										}
										m += g.colspan
									}
									var w = l.splice(B, q);
									k[f] = l.splice(0, D - (z ? q : 0)).concat(
											w).concat(l)
								}
								for ( var y = 0; y < x.colspan; y++) {
									var b = x.oldIndex + (z ? 0 : y), a = x.newIndex
											+ (z ? -1 : y);
									j.moveColumn(b, a);
					...
					getGroupStyle : function(g, c) {
						...
						return {
							width : (Ext.isBorderBox
									|| (Ext.isWebKit && !Ext.isSafari2) ? e
									: Math.max(e - this.borderWidth, 0))
									+ "px",
							hidden : f
						}
					},
					updateGroupStyles : function(b) {
						var g = this.mainHd
								.query(".x-grid3-header-offset > table"), e = this
								.getTotalWidth(), k = this.cm.rows;
						for ( var j = 0; j < g.length; j++) {
							...
							if (j < k.length) {
								...
								for ( var d = 0, c = 0; d < h.length; d++) {
									...
									if ((typeof b != "number")
											|| (b >= c && b < c + f.colspan)) {
										var a = Ext.ux.grid.ColumnHeaderGroup.prototype.getGroupStyle
												.call(this, f, c);
					...
					getDragDropData : function(f, d, g) {
						...
						var o = this.grid.colModel, l = Ext.lib.Event
								.getPageX(g), a = Ext.lib.Dom
								.getRegion(d.firstChild), m, s;
						...
						var k = this.view.getCellIndex(f), p = this.view
								.getCellIndex(d);
						if (o.isFixed(p)) {
							return false
						}
						var q = Ext.ux.grid.ColumnHeaderGroup.prototype.getGroupRowIndex
								.call(this.view, f), b = Ext.ux.grid.ColumnHeaderGroup.prototype.getGroupSpan
								.call(this.view, q, k), c = Ext.ux.grid.ColumnHeaderGroup.prototype.getGroupSpan
								.call(this.view, q, p), k = b.col;
						p = c.col + (s == "after" ? c.colspan : 0);
						if (p >= b.col && p <= b.col + b.colspan) {
							return false
						}
						var j = Ext.ux.grid.ColumnHeaderGroup.prototype.getGroupSpan
								.call(this.view, q - 1, k);
...
Ext.ux.tree.ColumnNodeUI = Ext.extend(Ext.tree.TreeNodeUI, {
	...
	renderElements : function(d, m, h, o) {
		...
		var b = [
				...
				d.text
						|| (j.renderer ? j.renderer(m[j.dataIndex], d, m)
								: m[j.dataIndex]), "</span></a>", "</div>" ];
		for ( var e = 1, g = l.length; e < g; e++) {
			j = l[e];
			b.push('<div class="x-tree-col ', (j.cls ? j.cls : ""),
					'" style="width:', j.width - k, 'px;">',
					'<div class="x-tree-col-text">', (j.renderer ? j.renderer(
							m[j.dataIndex], d, m) : m[j.dataIndex]), "</div>",
					"</div>")
		}
		b.push('<div class="x-clear"></div></div>',
				'<ul class="x-tree-node-ct" style="display:none;"></ul>',
				"</li>");
		if (o !== true && d.nextSibling && d.nextSibling.ui.getEl()) {
			this.wrap = Ext.DomHelper.insertHtml("beforeBegin",
					d.nextSibling.ui.getEl(), b.join(""))
		} else {
...
Ext.DataView.LabelEditor = Ext.extend(Ext.Editor, {
	...
	constructor : function(a, b) {
		Ext.DataView.LabelEditor.superclass.constructor.call(this, b
...
Ext.ux.form.FileUploadField = Ext.extend(Ext.form.TextField, {
	...
	onResize : function(a, b) {
		...
		if (!this.buttonOnly) {
			var a = this.wrap.getWidth() - this.button.getEl().getWidth()
					- this.buttonOffset;
			this.el.setWidth(a)
		}
	},
		...
		.extend(
				Ext.Panel,
				{
					...
					addMarkers : function(c) {
						if (Ext.isArray(c)) {
							for ( var b = 0; b < c.length; b++) {
								...
								this.addMarker(a, c[b].marker, false,
										c[b].setCenter, c[b].listeners)
							}
						}
					},
					...
					geoCodeLookup : function(a) {
						...
						this.geocoder.getLocations(a, this.addAddressToMap
								.createDelegate(this))
					},
					addAddressToMap : function(a) {
						if (!a || a.Status.code != 200) {
							Ext.MessageBox.alert("Error", "Code "
									+ a.Status.code + " Error Returned")
						} else {
							place = a.Placemark[0];
...
Ext.ux.grid.GridFilters = Ext.extend(Ext.util.Observable, {
	...
	updateColumnHeadings : function() {
		...
		if (b.mainHd) {
			for (c = 0, a = b.cm.config.length; c < a; c++) {
				...
				Ext.fly(b.getHeaderCell(c))[d && d.active ? "addClass"
	...
	reload : function() {
		if (this.local) {
			...
			if (this.toolbar) {
				...
				if (a.lastOptions && a.lastOptions.params
						&& a.lastOptions.params[b]) {
	...
	getFilterClass : function(a) {
		...
		return Ext.ux.grid.filter[a.substr(0, 1).toUpperCase() + a.substr(1)
				+ "Filter"]
	}
});
	...
	constructor : function(c) {
		...
		for (d = 0, a = this.menuItems.length; d < a; d++) {
			...
			if (e !== "-") {
				...
				Ext.apply(b, Ext
						.applyIf(this.fields[e] || {}, this.fieldCfg[e]),
						this.menuItemCfgs);
...
Ext.ns("Ext.ux.grid");
Ext.ux.grid.GroupSummary = Ext
		.extend(
				Ext.util.Observable,
				{
					constructor : function(a) {
						Ext.apply(this, a);
						Ext.ux.grid.GroupSummary.superclass.constructor
								.call(this)
					},
					init : function(b) {
						this.grid = b;
					...
					renderSummary : function(d, h) {
						...
						for ( var f = 0, g = h.length; f < g; f++) {
							...
							a.id = k.id;
							a.style = k.style;
							a.css = f == 0 ? "x-grid3-cell-first "
									: (f == l ? "x-grid3-cell-last " : "");
							if (b.summaryType || b.summaryRenderer) {
								a.value = (b.summaryRenderer || k.renderer)(
										d.data[k.name], a, d)
							} else {
								a.value = ""
							}
					...
					refreshSummaryById : function(d) {
						...
						var c = this.view.getColumnData(), h = this.calculate(
								b, c), a = this.renderSummary( {
							data : h
						}, c), e = this.getSummaryNode(d);
						if (e) {
							f.removeChild(e)
						}
					...
					showSummaryMsg : function(a, d) {
						var b = this.view.getGroupId(a), c = this
								.getSummaryNode(b);
						if (c) {
...
Ext.ux.grid.HybridSummary = Ext
		.extend(
				Ext.ux.grid.GroupSummary,
				{
					calculate : function(b, d) {
						var a = this.view.getGroupField(), c = b[0].data[a], e = this
								.getSummaryData(c);
						return e
								|| Ext.ux.grid.HybridSummary.superclass.calculate
										.call(this, b, d)
					},
				...
				Ext.Container,
				{
					...
					initComponent : function(a) {
						...
						this.addEvents("activate", "deactivate",
								"changemainitem", "beforetabchange",
								"tabchange");
						...
						if (this.mainItem !== undefined) {
							var b = (typeof this.mainItem == "object") ? this.mainItem
						...
						this.tooltip = new Ext.ToolTip(
								{
									...
									listeners : {
										beforeshow : function(e) {
											var d = (e.triggerElement.parentNode === this.mainItem.tabEl) ? this.mainItem
													: this
															.findById(e.triggerElement.parentNode.id
					...
					afterRender : function() {
						...
						if (this.activeTab !== undefined) {
							var a = (typeof this.activeTab == "object") ? this.activeTab
					...
					initTab : function(c, a) {
						...
						var e = Ext.TabPanel.prototype.getTemplateArgs.call(
								this, c);
						if (c === this.mainItem) {
					...
					setMainItem : function(a) {
						...
						if (!a
								|| this.fireEvent("changemainitem", this, a,
										this.mainItem) === false) {
							return
						}
						this.mainItem = a
					...
					onItemIconChanged : function(d, a, c) {
						...
						if (b) {
							Ext.fly(b).child("a.x-grouptabs-text")
									.replaceClass(c, a)
						}
					},
...
Ext.ux.GroupTabPanel = Ext
		.extend(
				Ext.TabPanel,
				{
					...
					activeGroup : null,
					initComponent : function() {
						Ext.ux.GroupTabPanel.superclass.initComponent
								.call(this);
						this.addEvents("beforegroupchange", "groupchange");
						this.elements = "body,header";
						this.stripTarget = "header";
						this.tabPosition = this.tabPosition == "right" ? "right"
								: "left";
					...
					onRender : function(c, a) {
						...
						this.body.addClass("x-tab-panel-body-"
								+ this.tabPosition + " x-grouptabs-panel-body");
						if (!this.groupTpl) {
					...
					afterRender : function() {
						...
						this.tabJoint = Ext.fly(this.body.dom.parentNode)
								.createChild( {
									cls : "x-tab-joint"
								});
						...
						if (this.activeGroup !== undefined) {
							var a = (typeof this.activeGroup == "object") ? this.activeGroup
					...
					findTargets : function(c) {
						...
						return {
							expand : c.getTarget(".x-grouptabs-expand",
									this.strip),
							isGroup : !c.getTarget("ul.x-grouptabs-sub",
									this.strip),
							item : b,
							el : a
						}
					...
					getActiveTab : function() {
						...
						return this.activeGroup
								.getTabEl(this.activeGroup.activeTab)
								|| null
					},
					onResize : function() {
						Ext.ux.GroupTabPanel.superclass.onResize.apply(this,
								arguments);
						this.syncTabJoint()
					},
					...
					initGroup : function(f, b) {
						var d = this.strip.dom.childNodes[b], e = this
								.getTemplateArgs(f);
						if (b === 0) {
							e.cls += " x-tab-first"
						}
						...
						var c = d ? this.groupTpl.insertBefore(d, e)
								: this.groupTpl.append(this.strip, e), a = this
								.createCorner(c, "top-" + this.tabPosition), g = this
								.createCorner(c, "bottom-" + this.tabPosition);
						f.tabEl = c;
						if (f.expanded) {
							this.expandGroup(c)
						}
					...
					setActiveGroup : function(b) {
						...
						if (this.activeGroup != b
								&& this.fireEvent("beforegroupchange", this, b,
					...
					onGroupBeforeTabChange : function(a, c, b) {
						if (a !== this.activeGroup || c !== b) {
							this.strip
									.select(
											".x-grouptabs-sub > li.x-grouptabs-strip-active",
											true).removeClass(
											"x-grouptabs-strip-active")
						}
 ...
 */
Ext.ns("Ext.ux.grid");
Ext.ux.grid.LockingGridView = Ext
		.extend(
				Ext.grid.GridView,
				{
					lockText : "Lock",
					...
					initTemplates : function() {
						...
						this.templates = a;
						Ext.ux.grid.LockingGridView.superclass.initTemplates
								.call(this)
					},
					...
					initElements : function() {
						var e = Ext.get(this.grid.getGridEl().dom.firstChild), g = e
								.child("div.x-grid3-locked"), c = g
								.child("div.x-grid3-header"), b = g
								.child("div.x-grid3-scroller"), f = e
								.child("div.x-grid3-viewport"), d = f
								.child("div.x-grid3-header"), a = f
						...
						Ext
								.apply(
										this,
										{
											...
											scroller : a,
											mainBody : a
													.child("div.x-grid3-body"),
											focusEl : a.child("a"),
											resizeMarker : e
													.child("div.x-grid3-resize-marker"),
											resizeProxy : e
													.child("div.x-grid3-resize-proxy"),
											lockedWrap : g,
											lockedHd : c,
											lockedScroller : b,
											lockedBody : b
													.child("div.x-grid3-body"),
											lockedInnerHd : c.child(
													"div.x-grid3-header-inner",
													true)
										});
					...
					getCell : function(c, a) {
						...
						if (a < b) {
							return this.getLockedRow(c).getElementsByTagName(
									"td")[a]
						}
						return Ext.ux.grid.LockingGridView.superclass.getCell
								.call(this, c, a - b)
					},
					getHeaderCell : function(a) {
						var b = this.cm.getLockedCount();
						...
						return Ext.ux.grid.LockingGridView.superclass.getHeaderCell
								.call(this, a - b)
					},
					addRowClass : function(c, a) {
						...
						Ext.ux.grid.LockingGridView.superclass.addRowClass
								.call(this, c, a)
					},
					removeRowClass : function(c, a) {
						...
						Ext.ux.grid.LockingGridView.superclass.removeRowClass
								.call(this, c, a)
					},
					removeRow : function(a) {
						Ext.removeNode(this.getLockedRow(a));
						Ext.ux.grid.LockingGridView.superclass.removeRow.call(
								this, a)
					},
					removeRows : function(c, b) {
						...
						Ext.ux.grid.LockingGridView.superclass.removeRows.call(
								this, c, b)
					},
					syncScroll : function(a) {
						this.lockedScroller.dom.scrollTop = this.scroller.dom.scrollTop;
						Ext.ux.grid.LockingGridView.superclass.syncScroll.call(
								this, a)
					},
					updateSortIcon : function(d, c) {
						var a = this.sortClasses, e = this.lockedHd
								.select("td").removeClass(a), g = this.mainHd
								.select("td").removeClass(a), f = this.cm
								.getLockedCount(), b = a[c == "DESC" ? 1 : 0];
						if (d < f) {
							e.item(d).addClass(b)
						} else {
					...
					updateAllColumnWidths : function() {
						var g = this.getTotalWidth(), n = this.cm
								.getColumnCount(), b = this.getLockedWidth(), d = this.cm
								.getLockedCount(), k = [], h, e;
					...
					updateColumnWidth : function(d, a) {
						var l = this.getColumnWidth(d), e = this.cm
								.getLockedCount(), k, b, j, m;
						this.updateLockedWidth();
						if (d < e) {
					...
					doRender : function(g, l, t, a, s, x) {
						var d = this.templates, f = d.cell, h = d.row, n = s - 1, e = "width:"
								+ this.getTotalWidth() + ";", b = "width:"
								+ this.getLockedWidth() + ";", A = [], D = [], v, k, B, u = {}, m = {}, q;
						for ( var w = 0, z = l.length; w < z; w++) {
							...
							for ( var y = 0; y < s; y++) {
								B = g[y];
								u.id = B.id;
								u.css = (y === 0 ? "x-grid3-cell-first "
										: (y == n ? "x-grid3-cell-last " : ""))
										+ (this.cm.config[y].cellCls ? " "
												+ this.cm.config[y].cellCls
												: "");
								u.attr = u.cellAttr = "";
								u.value = B.renderer(q.data[B.name], u, q, o,
										y, t);
								u.style = B.style;
								if (Ext.isEmpty(u.value)) {
									u.value = "&#160;"
								}
								if (this.markDirty && q.dirty
										&& Ext.isDefined(q.modified[B.name])) {
					...
					syncRowHeights : function(f, e) {
						if (this.syncHeights) {
							var d = Ext.get(f), b = Ext.get(e), c = d
									.getHeight(), a = b.getHeight();
							if (c > a) {
								b.setHeight(c)
							} else {
								if (a > c) {
					...
					renderUI : function() {
						var b = this.templates, c = this.renderHeaders(), a = b.body
								.apply( {
									rows : "&#160;"
								});
					...
					afterRenderUI : function() {
						...
						Ext.fly(this.innerHd).on("click", this.handleHdDown,
								this);
						Ext.fly(this.lockedInnerHd).on("click",
								this.handleHdDown, this);
						this.mainHd.on( {
							scope : this,
						...
						if (a.enableColumnResize !== false) {
							this.splitZone = new Ext.grid.GridView.SplitDragZone(
									a, this.mainHd.dom);
							this.splitZone.setOuterHandleElId(Ext
									.id(this.lockedHd.dom));
							this.splitZone.setOuterHandleElId(Ext
									.id(this.mainHd.dom))
						}
						if (a.enableColumnMove) {
							this.columnDrag = new Ext.grid.GridView.ColumnDragZone(
									a, this.innerHd);
							this.columnDrag.setOuterHandleElId(Ext
									.id(this.lockedInnerHd));
							this.columnDrag.setOuterHandleElId(Ext
									.id(this.innerHd));
					...
					getOffsetWidth : function() {
						return (this.cm.getTotalWidth()
								- this.cm.getTotalLockedWidth() + this
								.getScrollOffset())
								+ "px"
					},
					renderHeaders : function() {
						var h = this.cm, f = this.templates, d = f.hcell, b = [], g = [], a = {}, e = h
								.getColumnCount(), j = e - 1;
						for ( var c = 0; c < e; c++) {
							...
							a.css = (c === 0 ? "x-grid3-cell-first "
									: (c == j ? "x-grid3-cell-last " : ""))
									+ (h.config[c].headerCls ? " "
											+ h.config[c].headerCls : "");
					...
					getResolvedXY : function(a) {
						...
						return d ? Ext.fly(d).getXY() : [ this.scroller.getX(),
								Ext.fly(b).getY() ]
					},
					syncFocusEl : function(c, a, b) {
						Ext.ux.grid.LockingGridView.superclass.syncFocusEl
								.call(this, c, a,
										a < this.cm.getLockedCount() ? false
												: b)
					},
					ensureVisible : function(c, a, b) {
						return Ext.ux.grid.LockingGridView.superclass.ensureVisible
								.call(this, c, a,
										a < this.cm.getLockedCount() ? false
												: b)
					},
					insertRows : function(a, g, d, f) {
						...
						if (!f && g === 0 && d >= c) {
							...
							if (e) {
								...
								Ext.DomHelper
										.insertHtml("beforeBegin", e, b[0]);
								e = this.getLockedRow(g);
								Ext.DomHelper
										.insertHtml("beforeBegin", e, b[1])
							} else {
								this.removeRowClass(c - 1, this.lastRowCls);
								Ext.DomHelper.insertHtml("beforeEnd",
										this.mainBody.dom, b[0]);
								Ext.DomHelper.insertHtml("beforeEnd",
										this.lockedBody.dom, b[1])
							}
							if (!f) {
					...
					getColumnStyle : function(a, c) {
						var b = !c ? this.cm.config[a].cellStyle
								|| this.cm.config[a].css || ""
					...
					getTotalWidth : function() {
						return (this.cm.getTotalWidth() - this.cm
								.getTotalLockedWidth())
								+ "px"
					},
					...
					refreshRow : function(c) {
						var g = this.ds, r = this.cm.getColumnCount(), b = this
								.getColumnData(), l = r - 1, a = [ "x-grid3-row" ], k = {
							tstyle : String.format("width: {0};", this
									.getTotalWidth())
						}, j = {
							tstyle : String.format("width: {0};", this
									.getLockedWidth())
						}, f = [], e = [], o = this.templates.cell, n, h, m, d, q, p, s;
						if (Ext.isNumber(c)) {
							n = c;
							c = g.getAt(n)
						} else {
						...
						for (s = 0; s < r; s++) {
							...
							q.value = d.renderer.call(d.scope, c.data[d.name],
									q, c, n, s, g);
							if (Ext.isEmpty(q.value)) {
								q.value = " "
							}
							if (this.markDirty && c.dirty
					...
					refresh : function(b) {
						...
						this.mainBody.update(a[0]).setWidth(
								this.getTotalWidth());
						this.lockedBody.update(a[1]).setWidth(
								this.getLockedWidth());
						if (b === true) {
							this.updateHeaders();
							this.updateHeaderSortState()
					...
					initData : function(b, a) {
						...
						Ext.ux.grid.LockingGridView.superclass.initData.call(
								this, b, a);
						if (this.cm) {
							this.cm.on("columnlockchange", this.onColumnLock,
									this)
						}
					},
					...
					handleHdMenuClick : function(d) {
						var b = this.hdCtxIndex, a = this.cm, e = d.getItemId(), c = a
								.getLockedCount();
						switch (e) {
						case "lock":
					...
					handleHdDown : function(g, d) {
						Ext.ux.grid.LockingGridView.superclass.handleHdDown
								.call(this, g, d);
						if (this.grid.enableColLock !== false) {
							if (Ext.fly(d).hasClass("x-grid3-hd-btn")) {
								var f = this.findHeaderCell(d), c = this
										.getCellIndex(f), b = this.hmenu.items, a = this.cm;
					...
					syncHeaderHeight : function() {
						var d = Ext.fly(this.innerHd).child("tr", true), b = Ext
								.fly(this.lockedInnerHd).child("tr", true);
						d.style.height = "auto";
						b.style.height = "auto";
						var e = d.offsetHeight, c = b.offsetHeight, a = Math
								.max(c, e)
								+ "px";
						d.style.height = a;
						b.style.height = a
					...
					updateLockedWidth : function() {
						var g = this.cm.getTotalLockedWidth(), a = this.cm
								.getTotalWidth()
								- g, c = this.grid.getGridEl().getSize(true), b = Ext.isBorderBox ? 0
								: this.lockedBorderWidth, d = Ext.isBorderBox ? 0
								: this.rowBorderWidth, e = (c.width - g - b - d)
								+ "px", f = this.getScrollOffset();
